...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $mentor_org = mysqli_real_escape_string($con, $mentor_org);
    $mentor_work_field = mysqli_real_escape_string($con, $work_field);
    $password = mysqli_real_escape_string($con, $password);
    $years_exp = mysqli_real_escape_string($con, $years_exp);
    ...
    if (!empty($username) && !empty($password) && !empty($email) && !empty($profile_pic)) {
        ...
        if ($check_username_result && mysqli_num_rows($check_username_result) > 0) {
            ...
            $mentor_id = random_num(5, $con, 'mentor'); // Update to 5 digits as per your requirement
            ...
            $query = "INSERT INTO mentor (mentor_id, full_name, username, bio, email, password, profile_pic, gender, pronouns, age, mentor_org, work_field, ed_field) VALUES ('$mentor_id', '$full_name', '$username', '$bio', '$email', '$password', '$profile_pic_path', '$gender', '$pronouns', '$age', '$mentor_org', '$work_field' , '$ed_field')";
...
<head>
    ...
    <title>Mentor Signup Page</title>
    <link rel="stylesheet" href="index.css">
</head>
<body>

    <div id="header" class="animated slideInDown" style="animation-delay:1.8s;">
        <div id="title">Signup to InclusiMentor as Mentor</div><br>
        <div id="links">
    ...
    <center>
        <div id="middle">
            <div id="tagline" class="animated zoomIn" style="animation-delay:1.8s;">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="mentor_org" placeholder="Working Organisation:" required class="form-input">
                    <select name="work_field" required class="form-input">
        ...
        <a href="" class="footer-link">Made as a part of YCFP 2023 Program</a>
        </div>
        </div>
    </center>
